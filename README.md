...
| ☐   | [Lab 15 Parent POM, BOM &amp; filtering](labs/lab-15-parent-pom-bom.md)            | [19](concepts/19-parent-pom-bom-parameterization.md), [18](concepts/18-maven-build.md)                              | Extract properties, filter resources, parent POM + BOM      |

## 📚 Concept index

> Concepts 19–21 are field-notes additions covering real failures/quirks hit while building/deploying this app, cross-checked against current MuleSoft documentation where a documented behaviour exists. For the same material as copy-paste-ready, symptom-first runbooks, see [`troubleshooting/`](troubleshooting/README.md).
...
| 19  | [Parameterization, parent POM &amp; BOM](concepts/19-parent-pom-bom-parameterization.md)         |
| 20  | [CloudHub 2.0 Maven deploy: field notes](concepts/20-cloudhub2-maven-deploy-troubleshooting.md)  |
| 21  | [Exchange, API Manager &amp; tooling quirks](concepts/21-exchange-api-manager-tooling-quirks.md) |
...
troubleshooting/ scenario-based errors, exact symptoms, step-by-step fixes (mid-incident reference)
...
Maintained by [Kumar Aryan](https://github.com/Hands-On-Project-Lab) — MuleSoft MCD Level 1 (Credential `7629432`, [verify](https://trailhead.salesforce.com/en/credentials/certification-detail-print/?searchString=7/sKx1q6D2IpfzkKD+I6DqA3qfXfAZUrWcgQJiDxEhTX7C0/AazB64ORCNJZMALO)) and AWS Cloud Practitioner. Profile: [github.com/Hands-On-Project-Lab](https://github.com/Hands-On-Project-Lab/Hands-On-Project-Lab).
